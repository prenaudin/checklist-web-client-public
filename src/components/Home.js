  ...
  <div className="home">
      ...
      <div className="home-section-inner">
        <header className="home-header clearfix">
          ...
          <div className="home-logo">
            <img role="presentation" src={imgLogo} className="home-logo-img" />
            Checklist
          </div>
        </header>
        ...
        <div className="home-video">
          <img role="presentation" width={824} height={484} src={imgVideoPlaceholder} />
        </div>
      </div>
    </section>
    ...
    <section className="home-section home-section--companies">
      <div className="home-section-inner">
        ...
        <img role="presentation" className="home-companies-img" src={imgCompanies} />
        <Link className="btn btn-primary home-signup-btn" to="signup">
          Sign up for free
        </Link>
      </div>
